...
function TeamProject() {
    ...
    return (
        <div className='cursor-pointer mt-8 bg-slate-100 p-4 sm:p-8'>
                    ...
                    {teamProjects.map((project, index) => (
                        <div key={index} className='flex flex-col md:flex-row items-start gap-10 mb-24'>
                            <div className='flex-shrink-0'>
                                <img src={project.picture} alt={`${project.name} image`} className='h-auto w-full lg:w-[250px] lg:h-[300px] object-cover' />
                            </div>
                            <div className='flex flex-col'>
                                ...
                                <div className='flex flex-col sm:flex-row gap-4 mt-10'>
                                    <button
                                        className='bg-blue-500 text-white px-4 py-2 sm:px-2 sm:py-1 hover:bg-blue-700 text-sm sm:text-xs'
                                    ...
                                    <div className='relative'>
                                        ...
                                        {showDropdown[index] && (
                                            <div className='absolute top-full left-0 mt-2 border border-gray-300 rounded p-2 w-full bg-white'>
